...
export interface ApplicationState {
  ...
  ussd: fromUssd.State;
  trackedEntityTypes: fromTrackedEntityType.State;
...
export const reducers: ActionReducerMap<ApplicationState> = {
  ...
  trackedEntityTypes: fromTrackedEntityType.reducer,
...
export const selectDataelementState = createFeatureSelector<
  fromDataElement.State
>("dataelements");
export const selectDatasetState = createFeatureSelector<fromDataset.State>(
  "datasets"
);
export const selectTrackedEntityTypeState = createFeatureSelector<
  fromTrackedEntityType.State
>("trackedEntityTypes");
